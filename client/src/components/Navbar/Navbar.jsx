...
import logo from '../../assets/640px-Stack_Overflow_logo1.svg.png'
import search from '../../assets/search-icon-png-2.png'
...
const Navbar = () => {
  ...
  //     handleLogout();
  //   } else {
  //     dispatch(setCurrentUser(JSON.parse(localStorage.getItem('Profile')) ?? null));
  //   }
